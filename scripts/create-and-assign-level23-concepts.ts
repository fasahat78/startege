/**
 * Create missing concepts for Level 23 and assign them
 * 
 * This script:
 * 1. Creates ConceptCard records for missing concepts with placeholder definitions
 * 2. Assigns all concepts (existing + newly created) to Level 23
 */

import { prisma } from "../lib/db";
import { LEVEL_CONFIGS } from "../lib/levels";

// Level 23 concepts with metadata from CSV
const LEVEL_23_CONCEPTS = [
  {
    name: "Why Ethics Matter in AI Governance",
    domain: "Domain 1",
    category: "Ethical Frameworks",
    difficulty: "advanced",
    notes: "Positions ethics as governance input",
  },
  {
    name: "Ethical vs Legal vs Commercial Considerations",
    domain: "Domain 1",
    category: "Ethical Frameworks",
    difficulty: "advanced",
    notes: "Clarifies decision tensions",
  },
  {
    name: "Common Ethical Frameworks Used in AI Governance",
    domain: "Domain 1",
    category: "Ethical Frameworks",
    difficulty: "advanced",
    notes: "Introduces practical ethical models",
  },
  {
    name: "Using Ethical Principles to Guide AI Decisions",
    domain: "Domain 1",
    category: "Ethical Frameworks",
    difficulty: "advanced",
    notes: "Makes ethics operational",
  },
  {
    name: "Ethical Risk vs Legal Risk",
    domain: "Domain 1",
    category: "Ethical Frameworks",
    difficulty: "advanced",
    notes: "Explains limits of legal compliance",
  },
  {
    name: "Documenting Ethical Reasoning and Trade-Offs",
    domain: "Domain 1",
    category: "Ethical Frameworks",
    difficulty: "advanced",
    notes: "Connects ethics to accountability",
  },
  {
    name: "Ethical Evaluation of Fairness Trade-Offs",
    domain: "Domain 3",
    category: "Bias Fairness & Model Risk",
    difficulty: "advanced",
    notes: "Applies ethics to fairness",
  },
  {
    name: "Resolving Ethical Dilemmas in AI Governance",
    domain: "Domain 4",
    category: "Advanced Governance Scenarios",
    difficulty: "advanced",
    notes: "Judgement under moral ambiguity",
  },
  {
    name: "Who Decides Ethical Boundaries in Organisations",
    domain: "Domain 1",
    category: "Governance Structures & Roles",
    difficulty: "advanced",
    notes: "Reinforces accountability",
  },
  {
    name: "Explaining Ethical Decisions to Stakeholders",
    domain: "Domain 1",
    category: "Transparency & Communication",
    difficulty: "advanced",
    notes: "Builds legitimacy and trust",
  },
];
...
async function setupLevel23() {
  ...
  for (const conceptData of LEVEL_23_CONCEPTS) {
    try {
  ...
  const levelConfig = LEVEL_CONFIGS.find((c) => c.level === 23);
  if (!levelConfig) {
    throw new Error(`Level 23 config not found`);
  }

  let challenge = await (prisma as any).challenge.findFirst({
    where: { levelNumber: 23 },
  });
  ...
  console.log(`\n💾 Assigning concepts to Level 23...`);
  ...
  console.log(`✅ Assigned ${conceptIds.length} concepts to Level 23`);

  // Step 4: Set up LevelCategoryCoverage
  console.log(`\n📊 Setting up LevelCategoryCoverage...`);

  const categoryCoverage = [
    { categoryName: "Ethical Frameworks", domainName: "Domain 1", coverageType: "INTRODUCED" },
    { categoryName: "Bias Fairness & Model Risk", domainName: "Domain 3", coverageType: "PRACTICED" },
...
async function main() {
  console.log("🚀 Creating and assigning concepts for Level 23\n");
  ...
  try {
    ...
    console.log("   - Level 23 is ready for testing");
  } catch (error) {
    console.error("\n❌ Error:", error);
    throw error;
  }
