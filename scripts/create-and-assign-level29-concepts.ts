/**
 * Create missing concepts for Level 29 and assign them
 * 
 * This script:
 * 1. Creates ConceptCard records for missing concepts with placeholder definitions
 * 2. Assigns all concepts (existing + newly created) to Level 29
 */

import { prisma } from "../lib/db";
import { LEVEL_CONFIGS } from "../lib/levels";

// Level 29 concepts with metadata from CSV
const LEVEL_29_CONCEPTS = [
  {
    name: "Why Emerging Regulation Matters for AI Governance",
    domain: "Domain 2",
    category: "Emerging AI Regulation & Policy Trends",
    difficulty: "expert",
    notes: "Frames anticipation as governance responsibility",
  },
  {
    name: "Signals of Regulatory Direction and Intent",
    domain: "Domain 2",
    category: "Emerging AI Regulation & Policy Trends",
    difficulty: "expert",
    notes: "Teaches what to monitor",
  },
  {
    name: "Interpreting Draft Regulations and Soft Law",
    domain: "Domain 2",
    category: "Emerging AI Regulation & Policy Trends",
    difficulty: "expert",
    notes: "Prepares pre-enforcement governance",
  },
  {
    name: "Regulatory Convergence and Divergence Trends",
    domain: "Domain 2",
    category: "Emerging AI Regulation & Policy Trends",
    difficulty: "expert",
    notes: "Anticipates fragmentation",
  },
  {
    name: "Preparing Governance for Regulatory Uncertainty",
    domain: "Domain 2",
    category: "Emerging AI Regulation & Policy Trends",
    difficulty: "expert",
    notes: "Builds resilience",
  },
  {
    name: "Designing Governance That Survives Regulatory Change",
    domain: "Domain 2",
    category: "Emerging AI Regulation & Policy Trends",
    difficulty: "expert",
    notes: "Future-proofs frameworks",
  },
  {
    name: "Adapting Compliance Strategy to Emerging Rules",
    domain: "Domain 1",
    category: "Strategic Compliance & Governance Alignment",
    difficulty: "expert",
    notes: "Keeps compliance flexible",
  },
  {
    name: "Tracking and Responding to Global AI Regulatory Developments",
    domain: "Domain 2",
    category: "Multi-Jurisdictional Governance",
    difficulty: "expert",
    notes: "Applies governance dynamically",
  },
  {
    name: "Building Modular Compliance Controls",
    domain: "Domain 1",
    category: "Compliance Frameworks",
    difficulty: "expert",
    notes: "Enables regulatory adaptability",
  },
  {
    name: "Preparing for Future Enforcement Scenarios",
    domain: "Domain 4",
    category: "Enforcement Oversight & Remedies",
    difficulty: "expert",
    notes: "Tests foresight and readiness",
  },
];
...
async function setupLevel29() {
  ...
  for (const conceptData of LEVEL_29_CONCEPTS) {
    try {
  ...
  const levelConfig = LEVEL_CONFIGS.find((c) => c.level === 29);
  if (!levelConfig) {
    throw new Error(`Level 29 config not found`);
  }

  let challenge = await (prisma as any).challenge.findFirst({
    where: { levelNumber: 29 },
  });
  ...
  console.log(`\n💾 Assigning concepts to Level 29...`);
  ...
  console.log(`✅ Assigned ${conceptIds.length} concepts to Level 29`);

  // Step 4: Set up LevelCategoryCoverage
  console.log(`\n📊 Setting up LevelCategoryCoverage...`);

  const categoryCoverage = [
    { categoryName: "Emerging AI Regulation & Policy Trends", domainName: "Domain 2", coverageType: "INTRODUCED" },
    { categoryName: "Strategic Compliance & Governance Alignment", domainName: "Domain 1", coverageType: "PRACTICED" },
    { categoryName: "Multi-Jurisdictional Governance", domainName: "Domain 2", coverageType: "PRACTICED" },
...
async function main() {
  console.log("🚀 Creating and assigning concepts for Level 29\n");
  ...
  try {
    ...
    console.log("   - Level 29 is ready for testing");
  } catch (error) {
    console.error("\n❌ Error:", error);
    throw error;
  }
