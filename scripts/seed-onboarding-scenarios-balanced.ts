...
const scenarios: ScenarioData[] = [
  ...
  // ============================================
  {
    ...
    optionB: `Continue operations as-is since the system is already deployed and working well, and address compliance issues only if the authority takes formal action`,
    optionC: `Disable the chatbot immediately and wait for regulatory guidance before taking any further steps or conducting assessments`,
    optionD: `Only conduct a DPIA if the authority requests it formally, as proactive assessment may not be necessary at this stage`,
    correctAnswer: "A",
  ...
  },
  {
    ...
    optionB: `Wait to see if customers complain before taking action, as proactive notification may create unnecessary concern`,
    optionC: `Only fix the technical issue, as the system will correct itself over time once the data drift stabilizes`,
    optionD: `Immediately disable the system and conduct a full investigation before any remediation or customer notification`,
    correctAnswer: "A",
