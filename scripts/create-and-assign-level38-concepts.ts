/**
 * Create missing concepts for Level 38 and assign them
 * 
 * This script:
 * 1. Creates ConceptCard records for missing concepts with placeholder definitions
 * 2. Assigns all concepts (existing + newly created) to Level 38
 * 3. Sets up LevelCategoryCoverage for Level 38
 */

import { prisma } from "../lib/db";
import { LEVEL_CONFIGS } from "../lib/levels";

// Level 38 concepts with metadata
const LEVEL_38_CONCEPTS = [
  {
    name: "Limits of Existing AI Governance Frameworks",
    domain: "Domain 1",
    category: "Advanced Governance Framework Evolution",
    difficulty: "expert",
    notes: "Identifies framework gaps",
  },
  {
    name: "When and Why Framework Extension Is Necessary",
    domain: "Domain 1",
    category: "Advanced Governance Framework Evolution",
    difficulty: "expert",
    notes: "Justifies principled deviation",
  },
  {
    name: "Designing Framework Extensions Without Breaking Compliance",
    domain: "Domain 1",
    category: "Advanced Governance Framework Evolution",
    difficulty: "expert",
  ...
  {
    name: "Governing Novel AI Capabilities and Uses",
    domain: "Domain 1",
    category: "Advanced Governance Framework Evolution",
    difficulty: "expert",
    notes: "Handles frontier risks",
  },
  {
    name: "Incorporating Emerging Risks into Existing Frameworks",
    domain: "Domain 1",
    category: "Advanced Governance Framework Evolution",
    difficulty: "expert",
    notes: "Keeps frameworks relevant",
  },
  {
    name: "Maintaining Traceability When Extending Frameworks",
    domain: "Domain 1",
    category: "Advanced Governance Framework Evolution",
    difficulty: "expert",
    notes: "Prevents governance drift",
  },
  {
    name: "Evolving Framework Components Over Time",
    domain: "Domain 1",
    category: "Governance Framework Design",
    difficulty: "expert",
    notes: "Treats frameworks as living systems",
  },
  {
    name: "Adapting Risk Controls to Novel Threats",
    domain: "Domain 3",
    category: "Advanced Risk Management & Tolerance",
    difficulty: "expert",
    notes: "Governs new risks",
  },
  {
    name: "Anticipating Framework Alignment with Future Regulation",
    domain: "Domain 2",
    category: "Emerging AI Regulation & Policy Trends",
    difficulty: "expert",
    notes: "Avoids future misalignment",
  },
  {
    name: "Integrating New Governance Domains into Existing Structures",
    domain: "Domain 1",
...
async function main() {
  console.log("🚀 Setting up Level 38: Advanced Frameworks\n");

  const levelNumber = 38;
  ...
  for (const conceptData of LEVEL_38_CONCEPTS) {
  ...
  console.log("🔗 Assigning concepts to Level 38...");
  ...
  console.log(`✅ Assigned ${conceptIds.length} concepts to Level 38\n`);
  ...
  const practicedCategories = [
    ...
    "Mastery Integration & Governance Coherence", // Domain 1
    "Advanced Risk Management & Tolerance", // Domain 3
    "Emerging AI Regulation & Policy Trends", // Domain 2
  ...
  for (const categoryName of introducedCategories) {
    ...
    if (category) {
      ...
      // Default to Domain 1 for Advanced Governance Framework Evolution
...
main()
  .then(() => {
    console.log("\n🎉 Level 38 setup successful!");
    process.exit(0);
  })
  .catch((error) => {
    console.error("\n❌ Error setting up Level 38:", error);
    process.exit(1);
  })
  .finally(async () => {
