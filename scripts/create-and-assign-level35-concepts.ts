/**
 * Create missing concepts for Level 35 and assign them
 * 
 * This script:
 * 1. Creates ConceptCard records for missing concepts with placeholder definitions
 * 2. Assigns all concepts (existing + newly created) to Level 35
 * 3. Sets up LevelCategoryCoverage for Level 35
 */

import { prisma } from "../lib/db";
import { LEVEL_CONFIGS } from "../lib/levels";

// Level 35 concepts with metadata
const LEVEL_35_CONCEPTS = [
  {
    name: "Why AI Governance Requires Strategic Planning",
    domain: "Domain 1",
    category: "Strategic Governance Planning",
    difficulty: "expert",
    notes: "Positions governance as long-term capability",
  },
  {
    name: "Defining Long-Term AI Governance Objectives",
    domain: "Domain 1",
    category: "Strategic Governance Planning",
    difficulty: "expert",
    notes: "Clarifies future-state intent",
  },
  {
    name: "Sequencing Governance Capabilities Over Time",
    domain: "Domain 1",
    category: "Strategic Governance Planning",
    difficulty: "expert",
    notes: "Prevents mis-timed controls",
  },
  {
    name: "Balancing Short-Term Compliance with Long-Term Vision",
    domain: "Domain 1",
    category: "Strategic Governance Planning",
    difficulty: "expert",
    notes: "Reflects planning tension",
  },
  {
    name: "Building Governance Roadmaps Under Uncertainty",
    domain: "Domain 1",
    category: "Strategic Governance Planning",
    difficulty: "expert",
    notes: "Plans despite unknowns",
  },
  {
    name: "Governance Investment Trade-Offs",
    domain: "Domain 1",
    category: "Strategic Governance Planning",
    difficulty: "expert",
    notes: "Forces prioritisation",
  },
  {
    name: "Aligning AI Governance Roadmaps with Enterprise Roadmaps",
    domain: "Domain 1",
    category: "Multi-Domain Governance Integration",
    difficulty: "expert",
    notes: "Prevents organisational misalignment",
  },
  {
    name: "Planning for Risk Evolution and Accumulation",
    domain: "Domain 3",
    category: "Advanced Risk Management & Tolerance",
    difficulty: "expert",
    notes: "Anticipates future risk",
  },
  {
    name: "Incorporating Regulatory Foresight into Governance Plans",
    domain: "Domain 2",
    category: "Emerging AI Regulation & Policy Trends",
    difficulty: "expert",
    notes: "Keeps plans adaptable",
  },
  {
    name: "Planning for Sustainable Compliance at Scale",
    domain: "Domain 1",
    category: "Strategic Compliance & Governance Alignment",
    difficulty: "expert",
    notes: "Avoids brittle compliance",
  },
];
...
async function main() {
  console.log("🚀 Setting up Level 35: Strategic Planning\n");

  const levelNumber = 35;
  ...
  for (const conceptData of LEVEL_35_CONCEPTS) {
  ...
  console.log("🔗 Assigning concepts to Level 35...");
  ...
  console.log(`✅ Assigned ${conceptIds.length} concepts to Level 35\n`);
  ...
  for (const categoryName of introducedCategories) {
    ...
    if (category) {
      ...
      // Default to Domain 1 for Strategic Governance Planning
...
main()
  .then(() => {
    console.log("\n🎉 Level 35 setup successful!");
    process.exit(0);
  })
  .catch((error) => {
    console.error("\n❌ Error setting up Level 35:", error);
    process.exit(1);
  })
  .finally(async () => {
