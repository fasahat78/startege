/**
 * Create missing concepts for Level 37 and assign them
 * 
 * This script:
 * 1. Creates ConceptCard records for missing concepts with placeholder definitions
 * 2. Assigns all concepts (existing + newly created) to Level 37
 * 3. Sets up LevelCategoryCoverage for Level 37
 */

import { prisma } from "../lib/db";
import { LEVEL_CONFIGS } from "../lib/levels";

// Level 37 concepts with metadata
const LEVEL_37_CONCEPTS = [
  {
    name: "What Integrated AI Governance Looks Like",
    domain: "Domain 1",
    category: "Mastery Integration & Governance Coherence",
    difficulty: "expert",
    notes: "Defines integrated end-state",
  },
  {
    name: "Maintaining Consistency Across Governance Decisions",
    domain: "Domain 1",
    category: "Mastery Integration & Governance Coherence",
    difficulty: "expert",
    notes: "Prevents contradictions",
  },
  {
    name: "Aligning Ethics Risk Law and Strategy Coherently",
    domain: "Domain 1",
    category: "Mastery Integration & Governance Coherence",
    difficulty: "expert",
    notes: "Full synthesis",
  },
  {
    name: "Resolving Tensions Between Governance Domains",
    domain: "Domain 1",
    category: "Mastery Integration & Governance Coherence",
    difficulty: "expert",
    notes: "Principled conflict resolution",
  },
  {
    name: "Maintaining Governance Integrity Over Time",
    domain: "Domain 1",
    category: "Mastery Integration & Governance Coherence",
    difficulty: "expert",
    notes: "Guards against erosion",
  },
  {
    name: "Personal Governance Judgement and Responsibility",
    domain: "Domain 1",
    category: "Mastery Integration & Governance Coherence",
    difficulty: "expert",
    notes: "Anchors mastery",
  },
  {
    name: "Ensuring Coherence Across Governance Artefacts",
    domain: "Domain 1",
  ...
  {
    name: "Aligning Long-Term Governance Strategy with Day-to-Day Decisions",
    domain: "Domain 1",
    category: "Strategic Governance Planning",
    difficulty: "expert",
    notes: "Connects plan to action",
  },
  {
    name: "Maintaining Risk Consistency Across Decisions",
    domain: "Domain 3",
    category: "Advanced Risk Management & Tolerance",
    difficulty: "expert",
    notes: "Avoids selective tolerance",
  },
  {
    name: "Maintaining Governance Coherence Across Regions",
    domain: "Domain 2",
...
async function main() {
  console.log("🚀 Setting up Level 37: Mastery Integration\n");

  const levelNumber = 37;
  ...
  for (const conceptData of LEVEL_37_CONCEPTS) {
  ...
  console.log("🔗 Assigning concepts to Level 37...");
  ...
  console.log(`✅ Assigned ${conceptIds.length} concepts to Level 37\n`);
  ...
  for (const categoryName of introducedCategories) {
    ...
    if (category) {
      ...
      // Default to Domain 1 for Mastery Integration & Governance Coherence
...
main()
  .then(() => {
    console.log("\n🎉 Level 37 setup successful!");
    process.exit(0);
  })
  .catch((error) => {
    console.error("\n❌ Error setting up Level 37:", error);
    process.exit(1);
  })
  .finally(async () => {
