...
const scenarios: ScenarioData[] = [
  ...
  },
  {
    ...
    optionB: `Marketing materials showing the benefits of AI systems and user testimonials demonstrating positive outcomes`,
    optionC: `Risk assessments, compliance records, governance policies, technical documentation, and evidence of ongoing monitoring`,
  ...
  },
  {
    ...
    optionC: `Move all training to EU infrastructure to avoid any compliance issues, even if this increases costs significantly`,
    optionD: `Ensure appropriate safeguards for data transfer (e.g., Standard Contractual Clauses), conduct DPIA, and document lawful basis for processing`,
    correctAnswer: "D",
  ...
  },
  {
    ...
    optionB: `Only individual fairness (similar individuals receive similar treatment), focusing on case-by-case consistency`,
    optionC: `Equalized odds (equal true positive and false positive rates) combined with calibration (accurate probability estimates)`,
  ...
  },
  {
    ...
    optionC: `Defer all ethical decisions to the vehicle manufacturer's legal team, as they understand regulatory requirements`,
    optionD: `Engage stakeholders, consider multiple ethical perspectives, document ethical choices transparently, and ensure human oversight for critical decisions`,
    correctAnswer: "D",
  ...
  },
  {
    ...
    optionC: `Conduct comprehensive impact assessments considering democratic health, information quality, social cohesion, and long-term consequences, even if it reduces short-term engagement`,
    optionD: `Only consider immediate user feedback and engagement metrics, as these directly reflect user preferences`,
    correctAnswer: "C",
  ...
  },
  {
    ...
    optionC: `Only anonymize the data and proceed with research, as anonymization addresses privacy concerns`,
  ...
  },
  {
    ...
    optionB: `Only implement monitoring for model performance, tracking accuracy and error rates`,
    optionC: `Implement data versioning, model versioning, logging, monitoring, explainability features, and audit trails`,
  ...
  },
  {
    ...
    optionC: `Make the system slower to accommodate full explainability, ensuring comprehensive explanations are always available`,
    optionD: `Implement efficient explainability methods (e.g., feature importance, simplified models) that can run in real-time, with detailed explanations available on-demand`,
    correctAnswer: "D",
  ...
  },
  {
    ...
    optionC: `Implement version control, change detection, rollback capabilities, performance monitoring, and approval workflows for model updates`,
    optionD: `Only monitor performance metrics, ensuring the model continues to meet accuracy thresholds`,
    correctAnswer: "C",
  ...
  },
  {
    ...
    optionC: `Collect all available data and anonymize it later, addressing privacy concerns through post-processing`,
  ...
  },
  {
    ...
    optionB: `Only new systems need to comply, and existing systems can continue operating without changes`,
    optionC: `The organization must bring the system into compliance with AI Act requirements, including risk management, data governance, and documentation, within the transition period`,
  ...
  },
  {
    ...
    optionC: `Continue processing but inform the customer, as the right to object doesn't require immediate cessation`,
    optionD: `The company must stop processing the objecting individual's data for marketing purposes, unless it can demonstrate compelling legitimate grounds that override the individual's interests`,
    correctAnswer: "D",
  ...
  },
  {
    ...
    optionC: `The organization must provide meaningful information about the logic involved, significance, and consequences, and allow the individual to obtain human intervention and contest the decision`,
    optionD: `Only provide a simple explanation that the AI denied the application, without technical details`,
    correctAnswer: "C",
  ...
  },
  {
    ...
    optionC: `The company can choose any member state as lead authority, selecting the most convenient jurisdiction`,
  ...
  },
  {
    ...
    optionB: `Only govern high-risk systems, leaving other systems to departmental discretion`,
    optionC: `Establish a centralized AI governance framework with clear policies, standards, and oversight, while allowing departments flexibility within the framework`,
  ...
  },
  {
    ...
    optionC: `Copy the competitor's approach without governance, assuming they've addressed compliance requirements`,
    optionD: `Implement essential governance measures upfront (risk assessment, basic compliance), plan for comprehensive governance post-launch, and ensure no high-risk violations`,
    correctAnswer: "D",
  ...
  },
  {
    ...
    optionC: `Quantify avoided costs (fines, litigation, reputation damage), demonstrate compliance value, show competitive advantage, and align with strategic objectives`,
    optionD: `Only justify if regulators require it, as voluntary governance may not be necessary`,
    correctAnswer: "C",
  ...
  },
  {
    ...
    optionC: `Only implement governance in markets with existing regulations, avoiding premature compliance`,
  ...
  },
  {
    ...
    optionB: `Only provide the data itself, as access rights focus on data rather than processing methods`,
    optionC: `Provide information about the data being processed, purposes, recipients, retention periods, data subject rights, and meaningful information about automated decision-making logic`,
  ...
  },
  {
    ...
    optionC: `Third-country processing is not allowed, requiring all processing to occur within the EU`,
    optionD: `Ensure appropriate safeguards for transfers (SCCs/adequacy), conduct DPIA, implement data subject rights, provide transparency, and ensure security measures`,
    correctAnswer: "D",
  ...
  },
  {
    ...
    optionC: `Notify the supervisory authority within 72 hours if the breach is likely to result in a risk to individuals' rights, and notify affected individuals without undue delay if high risk`,
    optionD: `Only notify if individuals complain, as proactive notification may cause unnecessary concern`,
    correctAnswer: "C",
  ...
  },
  {
    ...
    optionC: `Special category data can be processed freely for research, as research purposes override privacy concerns`,
  ...
  },
  {
    ...
    optionB: `Let the client decide, as they understand their system best`,
    optionC: `Conduct thorough risk assessment, consult with regulatory experts, document the analysis, and err on the side of higher-risk classification if uncertain`,
  ...
  },
  {
    ...
    optionC: `Simplify governance to reduce burden, removing non-essential requirements`,
    optionD: `Focus on change management, integrate governance into workflows, provide training and tools, demonstrate value, and establish accountability mechanisms`,
    correctAnswer: "D",
  ...
  },
  {
    ...
    optionC: `Prioritize based on risk level, impact on individuals, regulatory requirements, business criticality, and resource availability, focusing on high-risk/high-impact systems first`,
    optionD: `Only govern systems that are already compliant, building on existing strengths`,
    correctAnswer: "C",
  ...
  },
  {
    ...
    optionC: `Only comply with the least strict requirements, minimizing compliance burden`,
  ...
  },
  {
    ...
    optionB: `Only explain if users request it, avoiding unnecessary complexity for most users`,
    optionC: `Provide clear explanations of decisions, enable users to understand and contest decisions, implement appeal processes, and ensure human review for significant decisions`,
  ...
  },
  {
    ...
    optionC: `Update without testing, as testing delays improvements and users benefit from faster updates`,
    optionD: `Implement versioning, testing, gradual rollout, monitoring, user notification for significant changes, and rollback capabilities`,
    correctAnswer: "D",
  ...
  },
  {
    ...
    optionC: `Provide granular privacy controls, allow users to choose data sharing levels, implement differential privacy where possible, and ensure core functionality works with minimal data`,
    optionD: `Only personalize for users who share all data, as partial data reduces personalization quality`,
    correctAnswer: "C",
  ...
  },
  {
    ...
    optionC: `Restrict all unanticipated uses, ensuring the product is used only as intended`,
  ...
  },
  {
    ...
    optionB: `Assume all frameworks are the same, as they address similar concerns`,
    optionC: `Analyze each framework's scope, requirements, and enforcement mechanisms, identify overlaps and differences, consider practical implementation, and discuss implications for organizations`,
  ...
  },
  {
    ...
    optionC: `Avoid studying failures, as they may reflect poorly on organizations`,
    optionD: `Combine theoretical analysis with empirical research (case studies, interviews, surveys), examine implementation challenges, identify best practices, and analyze factors affecting success`,
    correctAnswer: "D",
  ...
  },
  {
    ...
    optionC: `Consider patient safety, privacy, informed consent, data protection, potential harms, benefit-risk analysis, and ensure research serves legitimate healthcare purposes`,
    optionD: `Only consider technical accuracy, as accurate systems benefit patients regardless of other factors`,
    correctAnswer: "C",
  ...
  },
  {
    ...
    optionC: `Only publish positive findings, as negative results don't contribute to knowledge`,
  ...
  },
  {
    ...
    optionB: `Only provide explanations if requested, as most users don't need detailed information`,
    optionC: `Implement fairness assessments, provide transparency and explanations, enable contestation, ensure accountability, and involve stakeholders in governance`,
  ...
  },
  {
    ...
    optionC: `Compliance is optional, and organizations can choose their level of governance`,
    optionD: `Conduct compliance assessment, identify applicable regulations, implement necessary measures (risk assessment, documentation, safeguards), and seek expert advice if needed`,
    correctAnswer: "D",
  ...
  },
  {
    ...
    optionB: `Only address concerns if legally required, as voluntary bias mitigation may not be necessary`,
    optionC: `Investigate the concerns, conduct bias assessment, implement mitigation measures if bias is found, consider pausing use if high risk, and communicate transparently with stakeholders`,
