/**
 * Create missing concepts for Level 17 and assign them
 * 
 * This script:
 * 1. Creates ConceptCard records for missing concepts with placeholder definitions
 * 2. Assigns all concepts (existing + newly created) to Level 17
 */

import { prisma } from "../lib/db";
import { LEVEL_CONFIGS } from "../lib/levels";

// Level 17 concepts with metadata from CSV
const LEVEL_17_CONCEPTS = [
  {
    name: "What Bias Means in AI Systems",
    domain: "Domain 3",
    category: "Bias Fairness & Model Risk",
    difficulty: "advanced",
    notes: "Establishes governance definition of bias",
  },
  {
    name: "Sources of Bias Across the AI Lifecycle",
    domain: "Domain 3",
    category: "Bias Fairness & Model Risk",
    difficulty: "advanced",
    notes: "Connects bias to lifecycle stages",
  },
  {
    name: "Fairness as a Governance Objective",
    domain: "Domain 3",
    category: "Bias Fairness & Model Risk",
    difficulty: "advanced",
    notes: "Frames fairness as value-driven decision",
  },
  {
    name: "Trade-Offs Between Fairness Accuracy and Utility",
    domain: "Domain 3",
    category: "Bias Fairness & Model Risk",
    difficulty: "advanced",
    notes: "Introduces governance tensions",
  },
  {
    name: "Protected Attributes and Sensitive Inference",
    domain: "Domain 3",
    category: "Bias Fairness & Model Risk",
    difficulty: "advanced",
    notes: "Grounds fairness in legal exposure",
  },
  {
    name: "Model Risk Beyond Bias",
    domain: "Domain 3",
    category: "Bias Fairness & Model Risk",
    difficulty: "advanced",
    notes: "Broadens model risk thinking",
  },
  {
    name: "Evidence of Fairness and Bias Controls",
    domain: "Domain 1",
    category: "Algorithmic Accountability & Assurance",
    difficulty: "advanced",
    notes: "Links behaviour to assurance artefacts",
  },
  {
    name: "Assessing Materiality of Bias Risks",
    domain: "Domain 3",
    category: "Risk Identification & Assessment",
    difficulty: "advanced",
    notes: "Teaches prioritisation",
  },
  {
    name: "Who Decides What Is Fair Enough",
    domain: "Domain 1",
    category: "Governance Structures & Roles",
    difficulty: "advanced",
    notes: "Reinforces accountable decision-making",
  },
  {
    name: "Explaining Fairness Decisions to Stakeholders",
    domain: "Domain 1",
    category: "Transparency & Communication",
    difficulty: "advanced",
    notes: "Builds stakeholder trust",
  },
];
...
async function setupLevel17() {
  ...
  for (const conceptData of LEVEL_17_CONCEPTS) {
    try {
  ...
  const levelConfig = LEVEL_CONFIGS.find((c) => c.level === 17);
  if (!levelConfig) {
    throw new Error(`Level 17 config not found`);
  }

  let challenge = await (prisma as any).challenge.findFirst({
    where: { levelNumber: 17 },
  });
  ...
  console.log(`\n💾 Assigning concepts to Level 17...`);
  ...
  console.log(`✅ Assigned ${conceptIds.length} concepts to Level 17`);

  // Step 4: Set up LevelCategoryCoverage
  console.log(`\n📊 Setting up LevelCategoryCoverage...`);

  const categoryCoverage = [
    { categoryName: "Bias Fairness & Model Risk", domainName: "Domain 3", coverageType: "INTRODUCED" },
...
async function main() {
  console.log("🚀 Creating and assigning concepts for Level 17\n");
  ...
  try {
    ...
    console.log("   - Level 17 is ready for testing");
  } catch (error) {
    console.error("\n❌ Error:", error);
    throw error;
  }
