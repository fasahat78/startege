...
-- Safe to run multiple times - will skip objects that already exist

-- Note: Some CREATE statements may show errors if objects exist, but the script will continue
...
-- Grant permissions to postgres user on all tables
DO $$
DECLARE
    r RECORD;
BEGIN
...
SELECT 'Schema application completed! Check for any errors above.' AS result;
